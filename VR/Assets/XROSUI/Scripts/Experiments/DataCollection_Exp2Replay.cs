...
public class DataCollection_Exp2Replay : MonoBehaviour
{
    ...
    private List<DataContainer_Exp2Peripersonal> _dataList = new List<DataContainer_Exp2Peripersonal>();
    private DataContainer_Exp2Peripersonal _dataContainer;
    ...
    void Start()
    {
        ...
        _dataList = CsvListToDataList<DataContainer_Exp2Peripersonal>(parsedList);
    }
...
//            print("currentIndex: " + currentIndex + " at " + Time.time);
            ...
            var g = _dataList[currentIndex].gesture;
            if (!g.Equals("None"))
            {
//                print(_dataList[currentIndex].gesture);
                if (g.Equals("_0800") || g.Equals("_0900") || g.Equals("_1000") || g.Equals("_1100"))
                {
                    predictModule.PredictSlotComparison(_dataList[currentIndex].gesture, ReplayHandL.transform.position, ReplayHandL.transform.rotation);
                }
                else
                {
                    predictModule.PredictSlotComparison(_dataList[currentIndex].gesture, ReplayHandR.transform.position, ReplayHandR.transform.rotation);
                }
            }
            currentIndex++;
        }
